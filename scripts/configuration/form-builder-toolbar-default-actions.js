...
angular.module('flowableModeler')
    ...
    var saveDialog = { name: $rootScope.currentForm.name,
            ...
            reusable: false,
            newVersion: false,
            width:$rootScope.currentForm.width,
            height:$rootScope.currentForm.height,
            comment: ''};
    ...
    $scope.save = function (additionalSaveCallback) {
        ...
        FormBuilderService.saveForm(data, $scope.saveDialog.name, $scope.saveDialog.formKey, 
        	$scope.saveDialog.description,$scope.saveDialog.width,$scope.saveDialog.height, saveCallback, errorCallback);
    };
