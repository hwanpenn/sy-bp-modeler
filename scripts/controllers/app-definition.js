...
angular.module('flowableModeler')
  .controller('AppDefinitionCtrl', ['$rootScope', '$scope', '$translate', '$http', '$location', '$routeParams', '$modal', '$popover', '$timeout','$sce',
                              function ($rootScope, $scope, $translate, $http, $location, $routeParams, $modal, $popover, $timeout,$sce) {
    ...
    $scope.loadApp = function() {
    	...
    	$http({method: 'GET', url: url}).
        	success(function(data, status, headers, config) {
				...
				$scope.html = $sce.trustAsHtml($scope.model.app.name);
        		$scope.loadVersions();
